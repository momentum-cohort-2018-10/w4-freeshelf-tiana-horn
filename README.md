...
To load some initial books, you can [create a data migration](https://docs.djangoproject.com/en/2.1/topics/migrations/#data-migrations), [use fixtures](https://docs.djangoproject.com/en/2.1/howto/initial-data/#providing-data-with-fixtures), or setup [django-import-export](https://simpleisbetterthancomplex.com/packages/2016/08/11/django-import-export.html).
...
Your next goal is adding registation and login to your application.
